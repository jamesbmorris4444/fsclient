...
public class SDVRequestProcessorLongEncryption3 extends MSCommunicationsWrapper {

    private static final String nameUsedForOutputToLogger = "longEncryption3Microservice: ";

    private byte[] incoming;
    private String dbResult;

    public SDVRequestProcessorLongEncryption3(int port) { super(port, nameUsedForOutputToLogger); }
    @Override
