...
public class SDVRequestProcessorLongEncryption extends MSCommunicationsWrapper {

    private static final String nameUsedForOutputToLogger = "longEncryptionMicroservice: ";
    private static final String calledMicroServiceName = "longencryption1";

    private byte[] incoming;
    private String dbResult;
    private int clientId;
    private SDVRequestProcessorLongEncryption1 ms;
    private int msIndex;

    public SDVRequestProcessorLongEncryption(int port) { super(port, nameUsedForOutputToLogger); }
    ...
    public void setOutputPayloads(Payload request) {
        ...
        if (msIndex < 0) {
            ...
            ms = (SDVRequestProcessorLongEncryption1) startMicroservice(msIndex);
            if (ms == null) {
