...
public class SDVRequestProcessorLongEncryption1 extends MSCommunicationsWrapper {

    private static final String nameUsedForOutputToLogger = "longEncryption1Microservice: ";
    private static final String calledMicroServiceName = "longencryption2";

    private byte[] incoming;
    private String dbResult;
    private int clientId;
    private SDVRequestProcessorLongEncryption2 ms;
    private int msIndex;

    public SDVRequestProcessorLongEncryption1(int port) { super(port, nameUsedForOutputToLogger); }
    ...
    public void setOutputPayloads(Payload request) {
        ...
        if (msIndex < 0) {
            ...
            ms = (SDVRequestProcessorLongEncryption2) startMicroservice(msIndex);
            if (ms == null) {
