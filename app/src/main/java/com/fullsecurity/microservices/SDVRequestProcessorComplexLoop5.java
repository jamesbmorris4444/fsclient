...
public class SDVRequestProcessorComplexLoop5 extends MSCommunicationsWrapper {

    private static final String nameUsedForOutputToLogger = "complexLoop5Microservice: ";

    private byte[] incoming;
    private String dbResult;

    public SDVRequestProcessorComplexLoop5(int port) { super(port, nameUsedForOutputToLogger); }
