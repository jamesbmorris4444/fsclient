...
public class SDVRequestProcessorComplexLoop4 extends MSCommunicationsWrapper {

    private static final String nameUsedForOutputToLogger = "complexLoop4Microservice: ";

    private byte[] incoming;
    private String dbResult;

    public SDVRequestProcessorComplexLoop4(int port) { super(port, nameUsedForOutputToLogger); }
