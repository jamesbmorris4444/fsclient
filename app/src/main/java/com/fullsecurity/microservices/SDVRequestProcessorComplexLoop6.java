...
public class SDVRequestProcessorComplexLoop6 extends MSCommunicationsWrapper  {

    private static final String nameUsedForOutputToLogger = "complexLoop6Microservice: ";

    private byte[] incoming;
    private String dbResult;

    public SDVRequestProcessorComplexLoop6(int port) { super(port, nameUsedForOutputToLogger); }
